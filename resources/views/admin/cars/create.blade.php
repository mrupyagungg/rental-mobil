                    ...
                    <div class="form-group row border-bottom pb-4">
                      ...
                      <div class="col-sm-10">
                          <select class="form-control" name="type_id" id="type_id">
                              <option {{ old('type') == 1 ? 'selected' : null }} value="sedan">Sedan</option>
                              <option {{ old('type') == 2 ? 'selected' : null }} value="suv">SUV</option>
                              <option {{ old('type') == 3 ? 'selected' : null }} value="heatback">Hatchback</option>
                          </select>
                      </div>
                  </div>                  
                    <div class="form-group row border-bottom pb-4">
